...
//Determine the most repeated word in the String
public class Repeated {
    ...
    public static String findMostRepeatedWord(String s) {
        ...
        // Iterate through the wordCountMap to find out which word was repeated the most
        // and how many times.
        int max = 0;
    ...
    public static boolean isCommonWord(String item) {
        String[] commonWords = { "the", "a", "or", "an", "it", "and", "but", "is", "are", "of", "on", "to", "was",
